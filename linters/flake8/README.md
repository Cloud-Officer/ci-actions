# GitHub Action: Run flake8 with reviewdog

This action runs [flake8](https://pypi.org/project/flake8/) with
[reviewdog](https://github.com/reviewdog/reviewdog) on pull requests to improve
code review experience.

Based on [reviewdog/action-flake8](https://github.com/reviewdog/action-flake8).
...
jobs:
  ...
  flake8:
    ...
    steps:
      - name: Flake8
        id: flake8
        uses: cloud-officer/ci-actions/linters/flake8@v3
        with:
