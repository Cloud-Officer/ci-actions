...
| JS | axios | 1.13.3 | MIT | Promise based HTTP client for the browser and node.js | <https://axios-http.com> | 2025-09-15 | Low | HTTP client for Slack webhook API calls | Industry standard HTTP client with active maintenance |
