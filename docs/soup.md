...
| JS | axios | 1.16.1 | MIT | Promise based HTTP client for the browser and node.js | <https://axios-http.com> | 2026-05-22 | Low | HTTP client for Slack webhook API calls | Industry standard HTTP client with active maintenance |
