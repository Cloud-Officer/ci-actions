# GitHub Action: Licenses

This action runs [Snyk](https://snyk.co/SnykGH) to check for vulnerabilities and open source licenses.

Based on [snyk/actions/tree/master/setup](https://github.com/snyk/actions/tree/master/setup).
  ...
  php_unit_tests:
    ...
    steps:
      - name: Licenses
        ...
        uses: cloud-officer/ci-actions/licenses@master
        with:
          ssh-key: "${{secrets.SSH_KEY}}"
          snyk-token: "${{secrets.SNYK_TOKEN}}"
          snyk-org: "${{secrets.SNYK_ORG}}"
          snyk-parameters: "--all-projects"
```
