...
#
# Usage:
#   scripts/bump-external-actions.sh                          # dry run: list available bumps
#   scripts/bump-external-actions.sh --apply                  # edit files in place
#   scripts/bump-external-actions.sh --apply --pr-body-file body.md
#
...
function main()
{
  ...
  if [ -n "${pr_body_file}" ]; then
    local or notes
    {
      ...
      echo "Generated by \`scripts/bump-external-actions.sh\` (issue #212). Review the linked"
